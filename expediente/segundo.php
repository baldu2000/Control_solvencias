...
<head>
    <meta charset="UTF-8">
    <title>Expedientes de Segundo Grado</title>
    <style>
        body {
...
<body>
    <h1>Expedientes de Segundo Grado</h1>
    ...
    $sql = "SELECT * FROM Expediente WHERE grado = 'Segundo Grado'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No se encontraron expedientes de Segundo Grado.</p>";
    }
