...
<head>
    <meta charset="UTF-8">
    <title>Expedientes de Sexto Grado</title>
    <style>
        body {
...
<body>
    <h1>Expedientes de Sexto Grado</h1>
    ...
    $sql = "SELECT * FROM Expediente WHERE grado = 'Sexto Grado'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No se encontraron expedientes de Sexto Grado.</p>";
    }
