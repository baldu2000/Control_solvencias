...
<head>
    <meta charset="UTF-8">
    <title>Expedientes de Septimo Grado</title>
    <style>
        body {
...
<body>
    <h1>Expedientes de Septimo Grado</h1>
    ...
    $sql = "SELECT * FROM Expediente WHERE grado = 'Septimo Grado'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No se encontraron expedientes de Septimo Grado.</p>";
    }
