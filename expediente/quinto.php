...
<head>
    <meta charset="UTF-8">
    <title>Expedientes de Quinto Grado</title>
    <style>
        body {
...
<body>
    <h1>Expedientes de Quinto Grado</h1>
    ...
    $sql = "SELECT * FROM Expediente WHERE grado = 'Quinto Grado'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No se encontraron expedientes de Quinto Grado.</p>";
    }
