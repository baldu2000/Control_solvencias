...
<head>
    <meta charset="UTF-8">
    <title>Expedientes de Parvularia</title>
    <style>
        body {
...
<body>
    <h1>Expedientes de Parvularia</h1>
    ...
    $sql = "SELECT * FROM Expediente WHERE grado = 'Parvularia'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No se encontraron expedientes de Parvularia.</p>";
    }
