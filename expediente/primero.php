...
<head>
    <meta charset="UTF-8">
    <title>Expedientes de Primer Grado</title>
    <style>
        body {
...
<body>
    <h1>Expedientes de Primer Grado</h1>
    ...
    $sql = "SELECT * FROM Expediente WHERE grado = 'Primer Grado'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No se encontraron expedientes de Primer Grado.</p>";
    }
