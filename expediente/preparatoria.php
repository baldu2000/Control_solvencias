...
<head>
    <meta charset="UTF-8">
    <title>Expedientes de Preparatoria</title>
    <style>
        body {
...
<body>
    <h1>Expedientes de Preparatoria</h1>
    ...
    $sql = "SELECT * FROM Expediente WHERE grado = 'Preparatoria'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No se encontraron expedientes de Preparatoria.</p>";
    }
