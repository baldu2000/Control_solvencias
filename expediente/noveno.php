...
<head>
    <meta charset="UTF-8">
    <title>Expedientes de Noveno Grado</title>
    <style>
        body {
...
<body>
    <h1>Expedientes de Noveno Grado</h1>
    ...
    $sql = "SELECT * FROM Expediente WHERE grado = 'Noveno Grado'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No se encontraron expedientes de Noveno Grado.</p>";
    }
