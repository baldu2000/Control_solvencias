...
<head>
    <meta charset="UTF-8">
    <title>Expedientes de Octavo Grado</title>
    <style>
        body {
...
<body>
    <h1>Expedientes de Octavo Grado</h1>
    ...
    $sql = "SELECT * FROM Expediente WHERE grado = 'Octavo Grado'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No se encontraron expedientes de Octavo Grado.</p>";
    }
