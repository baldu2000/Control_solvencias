...
<head>
    <meta charset="UTF-8">
    <title>Expedientes de Cuarto Grado</title>
    <style>
        body {
...
<body>
    <h1>Expedientes de Cuarto Grado</h1>
    ...
    $sql = "SELECT * FROM Expediente WHERE grado = 'Cuarto Grado'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>No se encontraron expedientes de Cuarto Grado.</p>";
    }
