...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['agregar'])) {
    ...
    $sql = "INSERT INTO notas (nombre_estudiante, grado, materia, nota_febrero, nota_marzo, nota_abril, nota_mayo, nota_junio, nota_julio, nota_agosto, nota_septiembre, nota_octubre, nota_noviembre)
            VALUES ('$nombre', 'Sexto Grado', 'Lenguaje', '$febrero', '$marzo', '$abril', '$mayo', '$junio', '$julio', '$agosto', '$septiembre', '$octubre', '$noviembre')";
...
// Consulta para obtener las notas de Lenguaje para Sexto Grado
$query = "SELECT * FROM notas WHERE materia = 'Lenguaje' AND grado = 'Sexto Grado'";
...
<head>
    ...
    <title>Notas de Lenguaje - Sexto Grado</title>
    <style>
        body {
...
<body>
    <h1>Notas de Lenguaje - Sexto Grado</h1>
