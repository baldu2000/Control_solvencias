...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['actualizar'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        header('Location: ingles.php'); // Redirigir a la página de ingles
        exit();
    } else {
...
<head>
    ...
    <title>Editar Nota de Inglés</title>
    <style>
        body {
...
<body>
    ...
    <a href="ingles.php">Volver a Notas de Inglés</a>
</body>
</html>
