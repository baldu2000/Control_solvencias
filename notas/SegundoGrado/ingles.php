...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['agregar'])) {
    ...
    $sql = "INSERT INTO notas (nombre_estudiante, grado, materia, nota_febrero, nota_marzo, nota_abril, nota_mayo, nota_junio, nota_julio, nota_agosto, nota_septiembre, nota_octubre, nota_noviembre)
            VALUES ('$nombre', 'Segundo Grado', 'Ingles', '$febrero', '$marzo', '$abril', '$mayo', '$junio', '$julio', '$agosto', '$septiembre', '$octubre', '$noviembre')";
...
// Consulta para obtener las notas de Ingles para Segundo grado
$query = "SELECT * FROM notas WHERE materia = 'Ingles' AND grado = 'Segundo Grado'";
...
<head>
    ...
    <title>Notas de Inglés - Segundo Grado</title>
    <style>
        body {
...
<body>
    <h1>Notas de Inglés - Segundo Grado</h1>
