...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['agregar'])) {
    ...
    $sql = "INSERT INTO notas (nombre_estudiante, grado, materia, nota_febrero, nota_marzo, nota_abril, nota_mayo, nota_junio, nota_julio, nota_agosto, nota_septiembre, nota_octubre, nota_noviembre)
            VALUES ('$nombre', 'Segundo Grado', 'Artistica', '$febrero', '$marzo', '$abril', '$mayo', '$junio', '$julio', '$agosto', '$septiembre', '$octubre', '$noviembre')";
...
// Consulta para obtener las notas de Artistica para Segundo grado
$query = "SELECT * FROM notas WHERE materia = 'Artistica' AND grado = 'Segundo Grado'";
...
<head>
    ...
    <title>Notas de Artística - Segundo Grado</title>
    <style>
        body {
...
<body>
    <h1>Notas de Artística - Segundo Grado</h1>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<a href='editarartistica.php?id={$row['id']}'>Editar</a>";
