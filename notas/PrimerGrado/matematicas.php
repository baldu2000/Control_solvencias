...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['agregar'])) {
    ...
    $sql = "INSERT INTO notas (nombre_estudiante, grado, materia, nota_febrero, nota_marzo, nota_abril, nota_mayo, nota_junio, nota_julio, nota_agosto, nota_septiembre, nota_octubre, nota_noviembre)
            VALUES ('$nombre', 'Primer Grado', 'Matematicas', '$febrero', '$marzo', '$abril', '$mayo', '$junio', '$julio', '$agosto', '$septiembre', '$octubre', '$noviembre')";
...
// Consulta para obtener las notas de Matematicas para primer grado
$query = "SELECT * FROM notas WHERE materia = 'Matematicas' AND grado = 'Primer Grado'";
...
<head>
    ...
    <title>Notas de Matemáticas - Primer Grado</title>
    <style>
        body {
...
<body>
    <h1>Notas de Matemáticas - Primer Grado</h1>
