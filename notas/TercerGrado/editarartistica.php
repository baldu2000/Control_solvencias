...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['actualizar'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        header('Location: artistica.php'); // Redirigir a la página de artistica
        exit();
    } else {
...
<head>
    ...
    <title>Editar Nota de ArtÍstica</title>
    <style>
        body {
...
<body>
    <h1>Editar Nota de Artística</h1>
    ...
    <a href="artistica.php">Volver a Notas de Artística</a>
</body>
</html>
