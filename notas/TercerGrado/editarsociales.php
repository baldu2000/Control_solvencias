...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['actualizar'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        header('Location: sociales.php'); // Redirigir a la página de matemáticas
        exit();
    } else {
...
<head>
    ...
    <title>Editar Nota de Sociales</title>
    <style>
        body {
...
<body>
    ...
    <a href="sociales.php">Volver a Notas de Sociales</a>
</body>
</html>
