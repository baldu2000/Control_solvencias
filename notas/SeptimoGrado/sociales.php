...
$query = "SELECT * FROM notas WHERE materia = 'Sociales' AND grado = 'Septimo Grado'";
...
<head>
    ...
    <title>Notas de Sociales - Séptimo Grado</title>
    <style>
        body {
...
<body>
    <h1>Notas de Sociales - Séptimo Grado</h1>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<a href='editarsociales.php?id={$row['id']}'>Editar</a>";
