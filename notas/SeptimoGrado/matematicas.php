...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['agregar'])) {
    ...
    $sql = "INSERT INTO notas (nombre_estudiante, grado, materia, nota_febrero, nota_marzo, nota_abril, nota_mayo, nota_junio, nota_julio, nota_agosto, nota_septiembre, nota_octubre, nota_noviembre)
            VALUES ('$nombre', 'Septimo Grado', 'Matematicas', '$febrero', '$marzo', '$abril', '$mayo', '$junio', '$julio', '$agosto', '$septiembre', '$octubre', '$noviembre')";
...
// Consulta para obtener las notas de Matematicas para Septimo grado
$query = "SELECT * FROM notas WHERE materia = 'Matematicas' AND grado = 'Septimo Grado'";
...
<head>
    ...
    <title>Notas de Matemáticas - Séptimo Grado</title>
    <style>
        body {
...
<body>
    <h1>Notas de Matemáticas - Séptimo Grado</h1>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<a href='editarmatematicas.php?id={$row['id']}'>Editar</a>";
