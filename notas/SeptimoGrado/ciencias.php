...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['agregar'])) {
    ...
    $sql = "INSERT INTO notas (nombre_estudiante, grado, materia, nota_febrero, nota_marzo, nota_abril, nota_mayo, nota_junio, nota_julio, nota_agosto, nota_septiembre, nota_octubre, nota_noviembre)
            VALUES ('$nombre', 'Septimo Grado', 'Ciencias', '$febrero', '$marzo', '$abril', '$mayo', '$junio', '$julio', '$agosto', '$septiembre', '$octubre', '$noviembre')";
...
// Consulta para obtener las notas de Ciencias para Septimo grado
$query = "SELECT * FROM notas WHERE materia = 'Ciencias' AND grado = 'Septimo Grado'";
...
<head>
    ...
    <title>Notas de Ciencias - Séptimo Grado</title>
    <style>
        body {
...
<body>
    <h1>Notas de Ciencias - Septimo Grado</h1>
