...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['actualizar'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        header('Location: lenguaje.php'); // Redirigir a la página de Lenguaje
        exit();
    } else {
...
<head>
    ...
    <title>Editar Nota de Lenguaje</title>
    <style>
        body {
...
<body>
    ...
    <a href="lenguaje.php">Volver a Notas de Lenguaje</a>
</body>
</html>
