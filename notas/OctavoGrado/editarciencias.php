...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['actualizar'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        header('Location: ciencias.php'); // Redirigir a la página de ciencias
        exit();
    } else {
...
<head>
    ...
    <title>Editar Nota de Ciencias</title>
    <style>
        body {
...
<body>
    ...
    <a href="ciencias.php">Volver a Notas de Ciencias</a>
</body>
</html>
